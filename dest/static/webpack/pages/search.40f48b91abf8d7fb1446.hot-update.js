...
function Search(_ref2) {
  ...
  var _router$query = router.query,
      ...
      page = _router$query.page; // 执行这个插入，每次页面渲染的时候
  // 用于拼接路径的方法
